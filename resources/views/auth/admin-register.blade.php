...
<div class="min-h-screen flex items-center justify-center">
    <div class="bg-white p-6 rounded-xl shadow-md w-full max-w-md">
        <h1 class="text-xl font-bold mb-4">Registrasi Admin</h1>
        <form method="POST" action="/admin/register" class="space-y-4">
            ...
            <button type="submit" class="w-full bg-green-600 text-white font-bold py-2 rounded-lg">Daftar Admin</button>
        </form>
        <p class="text-xs text-gray-500 mt-4">Sudah punya akun? <a class="text-blue-600" href="/admin/login">Login admin</a></p>
    </div>
</div>
</body>
</html>
